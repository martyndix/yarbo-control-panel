...
?>
    <main class="container">
        ...
        <section class="card panel-section map-card" data-panel-id="map" data-module="yarbo">
            ...
            <p id="map-listen-status" class="map-areas-status">Listen captures MQTT command names. Load map backups, edit vertices, then Save to robot writes save_clean_area (docked, with confirm).</p>
            ...
            <div id="map-inspector" class="map-inspector hidden">
                <details>
                    ...
                    <p class="hint map-editor-hint">Load map backups (it draws that backup), edit vertices, then Save to robot while docked. Save uses save_clean_area, the command heard when renaming an area. A copy of the original is kept on the Pi.</p>
                </details>
            </div>
        </section>
