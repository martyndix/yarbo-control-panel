...
Rebuild after panel updates that bump Colour firmware (`0.2.7-color` and later): click **Build firmware** with Paper Colour selected (or Flash, which builds when source is newer).
